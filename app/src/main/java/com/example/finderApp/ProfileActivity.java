...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String uid = getIntent().getStringExtra("id").toString();
        //Views
        ...
        mUsersDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.get().load(dataSnapshot.child("image").getValue().toString()).placeholder(R.drawable.profile).into(mImage);
    ...
    protected void onResume() {
        super.onResume();
        finderApp.activityResumed();
    }

    @Override
    protected void onPause() {
        super.onPause();
        finderApp.activityPaused();
    }
}